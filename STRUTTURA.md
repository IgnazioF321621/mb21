...
- **Report** (Fase 5): «Report» · tre bottoni **Mese · Wes · Anno** · riga ‹ periodo › (Wes: «Wes Giu 2026 · 05/06 → in corso») · elenco a scalini: righe dei 5 gruppi con il totale; tocco → esiti sotto (colonne separate **numero** e **%**, verdi i risultati che contano, a 0 in grigio); tocco su un esito → nomi con data e modalità; tocco su un nome → **foglio Modifica azione** (da lì «Apri contatto» → scheda con «‹ Report» che torna qui) · riquadro **📈 Anno** (12 barre con numeri, legenda) · «🟪 Griglia PM · X di N ›» · per l'Admin **Date dei Wes** (elenco con Elimina, data + «+ Wes») e **BBS** (cantiere 18: «WES 10-2026», «BBS 09-2026», si sceglie **solo mese e anno**, conta l'ultimo caricato). Un evento con biglietti non si elimina (per i Wes si guardano i biglietti del mese)
