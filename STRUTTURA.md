...
- **Admin** (richiesta di Ignazio 16/09, pagina per i lavori dell'Admin): riquadro **📄 Carica file Amway** (vedi Import CSV Amway) · **🎟 Wes** e **🎟 BBS** spostati qui dal Report (elenco con Elimina, mese e anno + «+ Wes» / «+ BBS», conta l'ultimo caricato; un evento con biglietti non si elimina)
