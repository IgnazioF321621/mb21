...
- **Foglio unico «Modifica azione»** (`foglioAzione`, decisioni di Ignazio 15/09: un'azione per ogni passo del percorso, il foglio serve a **correggere**; **l'azione è di chi ascolta**): titolo = tipo · **Contatto** («l'esito è suo», Cambia) · per PM e Follow Up: se c'è l'ospite scritto a mano e nessun «Portato da», riga Ospite con **«⇄ L'esito è dell'ospite»** (sceglie o crea l'ospite: diventa il contatto, il contatto di prima va in «Portato da», l'ospite scritto si svuota) · **Portato da** (＋ Scegli / ×) · **Sottotipo** (chip) · **Esito** (chip; per Appuntamento cambiano col sottotipo) · **Giorno e ora** (la fine si sposta con la stessa durata) · **Note**; «👤 Apri contatto» (dove serve) o Annulla · **Salva** → avviso «Azione modificata [· coda aggiornata]» con **Annulla**. Tocco fuori o × chiude. Si apre da: **Report** (tocco su un nome) · **Griglia PM** (tocco su una casella) · **scheda contatto → Azioni → Modifica** (prima solo data e nota) · **Agenda** («✏️ Modifica» accanto a Sposta)
- **Scelta contatto** (`sceltaContatto`): foglio sopra l'altro, ricerca tra i nomi del partner loggato come la Lista (primi 20), «＋ Non c'è: aggiungi «nome» come Prospect» (entra in coda da oggi, come ogni nuovo Prospect)
