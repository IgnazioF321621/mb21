...
- ~~Rilievo della tab Check~~ — fatto il 15/09 (ripresa automatica, 18 foto, 8 scelte): `docs/MB21_v3_Check_come_e.md`. Quattro riquadri (Volume · Azione · Segni Vitali N21 · Crescita) con fatto / obiettivo / mese prima, e «Modifica Obiettivi» a 5 passi. **Prossimo: 5 domande a Ignazio (§6), una alla volta**
