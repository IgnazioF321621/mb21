...
Brief in bozza: `docs/MB21_v4_Brief_F7_Categorie.md` (situazione, 8 domande a Ignazio, strade possibili). ~~Domande a Ignazio~~ chiuse il 16/09 (brief §4b): **5 senza categoria al giorno da smistare in più delle chiamate** (e «Altri 5»), prima la categoria poi la chiamata lo stesso giorno (se no coda normale), partner e Admin, senza telefono come gli altri, Referral tolto dalle scelte. ~~Proposta~~ approvata il 16/09 (brief §4c): riquadro **«Da catalogare»** in Dashboard sotto la coda, bottoni categoria poi bottoni esito, «Altri 5», senza categoria fuori dalla coda normale. **Prossimo: dividere in lavori e partire dal primo**
