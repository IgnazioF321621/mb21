...
- ~~Lavori 1-4: calcoli, pagina Check, Segni Vitali spostati, prove~~ — fatti il 15/09: `check.js` con 10 prove; agosto e settembre 2026 di Ignazio uguali al Check di Glide (export del 13/09) in tutte le 12 voci; pagina controllata a larghezza telefono con i dati dell'export. **Provato da Ignazio il 15/09: funziona**. Domanda aperta: la tabella dei Segni Vitali in fondo al Check serve ancora, ora che c'è il grafico per voce?
