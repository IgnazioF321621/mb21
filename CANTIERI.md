...
- ~~Lavoro 4 · Utenti a righe chiuse + abbonamento~~ — fatto il 16/09: migrazione `20260916183500_abbonamento_in_comune.sql` applicata (`utenti.abbonamento_con`); righe chiuse con pallino e scadenza, aperte con «✓ Pagamento ricevuto», data a mano, «In comune con». Prove dashboard 15. **Pagina non vista nel browser da Claude: da provare da Ignazio**
- ~~Sottopagine e Nuovo utente~~ — fatto il 16/09 (Ignazio: «la pagina admin da cellulare mi sta venendo molto caotica»): menu Carica file Amway · Utenti · Wes · BBS, ognuno con la sua schermata; **＋ Nuovo utente** cercando il nome nella Lista Nomi di tutti (Filippo non era tra gli utenti, solo una scheda), email scritta a mano. **Codice Amway uguale per la coppia** (scelta A): migrazione `20260916190500_codice_amway_condiviso.sql` applicata. **Da provare da Ignazio**
- ~~Modifica utente~~ — fatto il 16/09 (Ignazio, dopo aver creato Filippo Arcoraci: nel codice era finito l'indirizzo dell'app, e i nomi di due parole): ✏️ Modifica nome, codice, email; codice solo numeri; ricerca a più parole. **Da sistemare da Ignazio: codice di Filippo** (mettere quello di Tonya). **Da provare**
- Lavoro 5 · banner in Dashboard (arancione 7 giorni prima, rosso scaduto, «Rinnova subito» → Revolut con causale; con abbonamento in comune vale la scadenza di chi paga)
- Lavoro 6 · accesso limitato da scaduto
- Lavoro 7 · Filippo Arcoraci e Michaela Caccamo utenti separati (oggi dentro «Tonya e Filippo», «Luca e Miki»): li crea Ignazio con «＋ Nuovo utente» (servono le loro email); da decidere se rinominare «Tonya e Filippo» e «Luca e Miki»
