...
**Deciso da Ignazio il 22/09 («al momento ok»)**: i pack **non condivisibili** (studio personale e avanzato) **per ora non si aprono**: in biblioteca entrano come materiale intero, con titolo, autore e argomento. **Più avanti vanno aperti anche loro** (Ignazio: «possiamo prendere spunto per un'esigenza di una traccia specifica che però è dentro un pack, che poi consiglieremo»): la biblioteca deve quindi prevedere fin dall'inizio che un materiale intero possa ricevere dopo le sue tracce, da Admin, senza rifare niente.
...
## Glide: com'era lo Sharing (rilievo del 22/09 in Arc, sola lettura; scheda di un Partner con 10 condivisioni, niente nomi qui)
- **La sezione Sharing della scheda** (tab: Onboarding · Dati · Azioni · Coach Yes · **Sharing**). In alto il riquadro **«Prossimo audio consigliato per fase #1 Interesse»**: copertina, titolo, «Pack … | Traccia nr. N», bottoni **«Indietro!»** e **«Avanti!»** che scorrono il consiglio (la prima traccia della fase non ancora condivisa). Sotto il bottone **«Audio +»**. Poi la tabella del registro: **Data · Fase · Titolo - Autore · Traccia nr. · Ascoltata** (interruttore) · «…». Nel caso visto: 10 righe in 10 giorni (18-28/05/2026), tutte ascoltate, nell'ordine 16 → 1 → 2 → 3 → 5 → 4 → 6 → 7 → 8 → 9; il consiglio era alla 13, perché le 10-12 (pubblico femminile) erano state saltate a mano
- **Ignazio 22/09**: «Tempo e denaro» (la 16) per prima è «**la regola consigliata, ma non sempre fatta**» → passo 1 consigliato, non obbligatorio · le tracce non adatte le saltava lui con «Avanti!», «in Glide non poteva essere automatico» → **nella v4 il consiglio salta da solo** le tracce non adatte (dal «per chi è indicata» e dal sesso del contatto; se manca, l'app lo chiede lì)
- **Il modulo «Aggiungi nuova condivisione»**: Data (obbligatoria) · Fase del Prospect (menu, obbligatoria) · Titolo - Autore (menu, obbligatorio) · Note · Ascoltata (interruttore) · Invia / Annulla. Nella v4, se la traccia arriva dal consiglio, è tutto già compilato: **un tocco**; il modulo intero resta per i casi a mano
- **La pagina BSM** (mai pubblicata; vista nell'editor di Glide): schede con copertina, numero e riassunto, nell'ordine del percorso di Ignazio (1 Tempo e denaro · 2 Dare Seguito 1 · 3 Dare Seguito 2 · 4 Diamanti · 5 Perché investire · 6 Risposte · 7 Un equilibrio · 8 Come organizzare un Piano in casa · 9 I primi passi · 10 L'opportunità sei tu …). Ignazio: «non era online perché non sapevo come sfruttarla, sono le stesse informazioni che ci sono sul sito» → nella v4 la biblioteca **non è una pagina da sfogliare**: è il motore del consiglio, e riassunto e «per chi è indicata» si leggono quando l'app propone la traccia
- **La pagina Libri** («La tua crescita personale»): Partner Select · il libro in corso (dal Check) · due contatori, **Pagine** lette nel mese in corso e **Letture** sui giorni con Check · menu «Seleziona un libro già letto» · «Esporta note libro» (→ repo `mb21-libri-export`, non si tocca) e «Torna al mese attuale» · **l'elenco delle note del Check per libro** (nota · libro · data · N pagine lette). È la lettura dei Check per libro, non un catalogo: nella v4 `check_giorno` ha già libro, pagine e note → la pagina Libri v4 nasce dai dati che ci sono già
...
- **Regola di Ignazio (22/09) sull'ordine**: «all'inizio, condividere tante tracce straniere può creare disagio a un nuovo: le diluivo in mezzo a tracce italiane» → in biblioteca ogni traccia ha il segno **oratore straniero** (Matz, Andrews, Sala, Dornan, Ross, Henderson) o italiano; il consiglio **non propone mai due straniere di fila**
- ~~**La fase delle 9 tracce nuove**~~ — ✅ deciso il 22/09 («al momento va bene così»): **il PDF resta l'autorità** per le 40; le 9 nuove entrano in biblioteca **senza fase**, come «in più»: il consiglio le propone quando una fase è finita, prima di passare alla successiva, oppure a mano con «un'altra»; la fase gliela dà Ignazio **da Admin, una alla volta**, quando si sarà fatto un'idea (la proposta di Claude, non adottata: #2 abitudine ai CD · Piano in casa · superare i «no» — #3 Non mollare mai · zavorra — #4 le tre di Andrews · Atteggiamento II)
- ~~**L'ordine di lettura dei libri**~~ — ✅ deciso il 22/09 (strada «B»: i primi libri in ordine, gli altri senza; «va bene così, aggiustiamo man mano»). Ignazio: «un nuovo non è prontissimo a leggere» · *È semplice, non ovvia*, *Il pianoforte sulla spiaggia*, *Strategie per il successo* e *La magia di pensare in grande* «li vende solo Network 21»: non si trovano in libreria né online, il nuovo li prende a un evento o se li fa portare · «di solito si cerca di capire quale può essere più utile alla persona». **Il percorso dei libri**: **0** il Manuale di Avvio N21 (arriva con lo Starter Pack; «la prima cosa da leggere e studiare»; da «studiato», senza pagine) → **1** un libro da libreria a scelta dello sponsor per la persona: *Come trattare gli altri e farseli amici* (Carnegie) oppure *Sviluppa la tua personalità* (Littauer) → **2** *È semplice, non ovvia* (Dornan) appena se lo procura → **3** *Il pianoforte sulla spiaggia* · *Strategie per il successo* · *La magia di pensare in grande*. Per la biblioteca: segno **«si trova solo da N21»** sui libri fuori commercio (il consiglio lo dice: «lo trovi da N21 o al prossimo evento» e intanto propone quello da libreria); il Manuale entra tra i materiali; regola del consiglio: **un libro alla volta**
