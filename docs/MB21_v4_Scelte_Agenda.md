# MB21 v4.0 — Scelte dell'Agenda

> Fase 4 · lavoro 1 · 14/09/2026. **Confermate da Ignazio il 14/09** (risposte sotto); in uso in `agenda.js` (`TIPI`, `SOTTOTIPI`). I nomi si ritoccano strada facendo.
...
1. Consulenza PRD: **Vendita · No Vendita** — sì
