...
4. ~~BBS, WES, CEP «Start»: cosa sono?~~ → **Risposta di Ignazio (15/09):** i numeri con cui si è **chiuso il mese precedente**; si aggiungono quelli del mese. **Si azzerano dopo ogni evento** e si riparte, ma il lavoro resta **mensile**. **Nota per la v4:** la partenza si prende già da sola dal mese prima (a catena), ma **nell'app non c'è modo di azzerarla** dopo un evento (il foglio Obiettivi salva solo i 12 obiettivi): da prevedere.
5. ~~Cosa serve dal Check?~~ → **Risposta di Ignazio (15/09):** i confronti che fanno capire **l'andamento della persona**: col **mese precedente**, col **quadrimestre precedente** (il **Wes** precedente), con l'**anno fiscale precedente** e **da inizio anno fiscale**. Da tenere presente: su GitHub ci sono già **Dashboard, Griglia PM e Segni Vitali** (anche la pagina a parte `mb21-segni-vitali`, da non toccare): Ignazio pensa che i Segni Vitali vadano **portati nel Check**. Nella v4 esistono già i periodi Mese · Wes · Anno (Report, tabella `wes`) e i Segni Vitali a 12 mesi in Dashboard.
