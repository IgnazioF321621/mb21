...
(function (radice) {
  const ELENCO = [
    { quando: '2026.09.19 · 07:45', pagina: 'app', titolo: '👋 Il benvenuto di MB21',
    ...
    { quando: '2026.09.19 · 07:45', pagina: 'dashboard', titolo: '🚀 Il mio avvio: «Perché iniziare» e la cerchia ristretta',
    ...
    { quando: '2026.09.19 · 07:45', pagina: 'dashboard', titolo: 'Partner da avviare: leggi il «perché» dei tuoi partner',
    ...
    { quando: '2026.09.19 · 07:45', pagina: 'dashboard', titolo: '📲 MB21 sul telefono e avvisi del mattino',
